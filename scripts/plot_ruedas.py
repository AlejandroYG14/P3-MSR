...
def main():
    parser = argparse.ArgumentParser(description="Grafica posicion angular de ruedas vs tiempo.")
    parser.add_argument("bag", help="Ruta a la carpeta del rosbag")
    parser.add_argument("--out", default="plots/pos_ruedas.png", help="Ruta de salida de la imagen")
    ...
    if not times:
        raise RuntimeError("No se han encontrado posiciones de ruedas.")
